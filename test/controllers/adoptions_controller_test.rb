...
class AdoptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adoption" do
    assert_difference("Adoption.count") do
      post adoptions_url, params: { adoption: { animal_id: @adoption.animal_id, description: @adoption.description, email: @adoption.email, name: @adoption.name, user_id: @adoption.user_id } }
    end
  ...
  test "should update adoption" do
    patch adoption_url(@adoption), params: { adoption: { animal_id: @adoption.animal_id, description: @adoption.description, email: @adoption.email, name: @adoption.name, user_id: @adoption.user_id } }
